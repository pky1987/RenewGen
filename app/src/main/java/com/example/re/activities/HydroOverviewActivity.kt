...
class HydroOverviewActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_hydro_overview)

        findViewById<TextView>(R.id.overviewTitle).text = getString(R.string.hydro_overview_title)
        findViewById<TextView>(R.id.overviewDescription).text = getString(R.string.hydro_overview_description)
    ...
    private fun setupKeyFactsCards() {
        val cards = listOf(
            FactCardData(
                ...
                titleRes = R.string.hydro_fact1_title,
                descriptionRes = R.string.hydro_fact1_description
            ),
            FactCardData(
                cardId = R.id.factCard2,
                titleId = R.id.factTitle2,
                descriptionId = R.id.factDescription2,
                titleRes = R.string.hydro_fact2_title,
                descriptionRes = R.string.hydro_fact2_description
            ),
            FactCardData(
                cardId = R.id.factCard3,
                titleId = R.id.factTitle3,
                descriptionId = R.id.factDescription3,
                titleRes = R.string.hydro_fact3_title,
                descriptionRes = R.string.hydro_fact3_description
            )
        )
